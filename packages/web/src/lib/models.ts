...
/**
 * Current-as-of-2026-04-16 baseline.
 *
 * Anthropic fallback entries in this file were verified against:
 * https://platform.claude.com/docs/en/about-claude/models/overview
 *
 * OpenAI fallback entries are also included below; when editing them, verify
 * them against OpenAI's published model and pricing documentation.
 *
