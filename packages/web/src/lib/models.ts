...
export const FALLBACK_MODELS: readonly FallbackModel[] = Object.freeze([
  ...
  // -- OpenAI -------------------------------------------------------------
  // Active frontier — gpt-5.x pricing not yet published, null until the
  // catalog refresh fills it in from live data.
  {
    provider: 'openai',
    model: 'gpt-5.4',
  ...
  },
  {
    ...
    inputUsdPerToken: 2.0 / 1_000_000,
    outputUsdPerToken: 8.0 / 1_000_000,
    lifecycleState: 'active',
    deprecatedAt: null,
    retiresAt: null,
    replacementModel: null,
